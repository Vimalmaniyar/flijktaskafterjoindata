...
class searchVC: UIViewController,CLLocationManagerDelegate,UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if searching==true {
            cell.city.text = searchCity[indexPath.row]
        }else{
            cell.city.text = arr[indexPath.row]
        }
  //  cell.textLabel?.text = arr[indexPath.row]
    ...
    func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
        searchCity = arr.filter({$0.prefix(searchText.count) == searchText})
        searching = true
    ...
    func changeLabel(){
        let vc = HomeVC()
        vc.displayLocation?.title = location.title
    }
       ...
       /* let url = "https://github.com/nshntarora/Indian-Cities-JSON/blob/master/cities.json"
        ...
        Alamofire.request(url)
            ...
            case .success(let JSON):
                ...
                let response = JSON as! Data
                print(response)
                //example if there is an id
               // let userId = response.object(forKey: "name")!
              //  print(userId)
        ...
        /*Alamofire.request("https://restcountries.eu/rest/v2/all").responseJSON{ response in
            ...
            if let dict = result.value as? Dictionary<String, Any>{
                if let innerDict = dict["name"]{
                    self.arr = innerDict as! [AnyObject]
                    print(self.arr)
                }
            }
